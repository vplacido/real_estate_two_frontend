...
class ListingsNewForm extends Component {
  ...
  constructor(props) {
   ...
   componentDidMount() {
    //  Geocoder.init("AIzaSyAJaSfMDa9BKofZ_yKgbGY2kWdp3BLlWmU");
  Geocode.setApiKey("AIzaSyAJaSfMDa9BKofZ_yKgbGY2kWdp3BLlWmU");
   }
  ...
  handleOnSubmit = e => {
    // this.changeLatLng(this.state.address)
    e.preventDefault()
    ...
    return(
      <div className='container'>
        <div className='new-listing-header'>
          <span id='new-listing-header-title'><b>Create a new listing</b></span>
          <br/>
          <br/>
